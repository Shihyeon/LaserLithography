...
[Figure 1]: readme/그림1.svg

## Setup

![Figure 2][Figure 2]

[Figure 2]: readme/그림2.svg

장치를 모두 연결한 후 프로그램을 실행하여, ...

## Code

`main.py`가 실행 파일이고, `controller.py`가 메인 실행 파일에 들어가는 모듈이다.

`config.yml`에서 초기값 설정을 할 수 있다.

`resiurces`에 `input_image.jpg`를 넣어 스캐닝하면 `filtered_values.csv` 데이터 파일이 만들어진다.

`log`는 명령어 실행 시 생성되는 로그이며, `src`는 개발 중 소스 파일이다.

### config.yml

<details>
<summary>config code [접기/펼치기]</summary>
...
<details>
<summary>import code [접기/펼치기]</summary>
...
<details>
<summary>ImageConverter code [접기/펼치기]</summary>
...
<details>
<summary>CSVDataReader code [접기/펼치기]</summary>
...
<details>
<summary>Logger code [접기/펼치기]</summary>
...
<details>
<summary>Motor code [접기/펼치기]</summary>
...
<details>
<summary>Laser code [접기/펼치기]</summary>
...
<details>
<summary>Recipe code [접기/펼치기]</summary>
...
<details>
<summary>Window code [접기/펼치기]</summary>
